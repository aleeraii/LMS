...
class Composable(object):
    ...
    `~cursor.executemany()`, `~cursor.copy_expert()` in place of the queries
    string.
    ...
    def as_string(self, context):
        ...
        passed instead of the queries string.
        """
...
class SQL(Composable):
    ...
    where to merge variable parts of a queries (for instance field or table
    names).
    ...
    Example::
        ...
        >>> queries = sql.SQL("select {0} from {1}").format(
        ...    sql.SQL(', ').join([sql.Identifier('foo'), sql.Identifier('bar')]),
        ...    sql.Identifier('table'))
        >>> print(queries.as_string(conn))
...
class Identifier(Composable):
    ...
    Example::
        ...
        >>> queries = sql.SQL("select {} from {}").format(
...
class Literal(Composable):
    """
    A `Composable` representing an SQL value to include in a queries.

    Usually you will want to include placeholders in the queries and pass values
    as `~cursor.execute()` arguments. If however you really really need to
    include a literal value in the queries you can use this object.
...
class Placeholder(Composable):
    """A `Composable` representing a placeholder for queries parameters.
